...
public class level3 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setFont(new java.awt.Font("Lucida Handwriting", 1, 57)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(0, 51, 255));
        jLabel2.setText("B O  M  U  J");
        ...
        jTextField1.setFont(new java.awt.Font("Wide Latin", 3, 24)); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (a.contains("JUMBO")||a.contains("jumbo"))
        {
            jTextField1.setText(null);
            setVisible(false);
                 level4 s3 = new level4();
                 s3.setVisible(true);
        }
        else
        {
